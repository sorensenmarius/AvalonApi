...
namespace MultiplayerAvalon.Migrations
{
    ...
    [Migration("20200608192001_Tester")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MultiplayerAvalon.AppDomain.Players.Player", b =>
                {
                    ...
                    b.HasIndex("TrueRoleId");

                    b.ToTable("Players");
                });

            modelBuilder.Entity("MultiplayerAvalon.AppDomain.Rounds.Round", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MultiplayerAvalon.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MultiplayerAvalon.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MultiplayerAvalon.AppDomain.Games.Game", b =>
                {
                    b.HasOne("MultiplayerAvalon.AppDomain.Players.Player", "CurrentPlayer")
                        .WithMany()
            ...
            modelBuilder.Entity("MultiplayerAvalon.AppDomain.Players.Player", b =>
                {
                    ...
                    b.HasOne("MultiplayerAvalon.AppDomain.GameRoles.Roles", "TrueRole")
                        .WithMany()
                        .HasForeignKey("TrueRoleId");
                });
